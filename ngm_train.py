...
in_u1 = tf.placeholder(tf.int32, [None, data.max_len], name="ull")
in_v1 = tf.placeholder(tf.int32, [None, data.max_len], name="vll")
in_u2 = tf.placeholder(tf.int32, [None, data.max_len], name="ulu")
in_v2 = tf.placeholder(tf.int32, [None, data.max_len], name="vlu")
in_u3 = tf.placeholder(tf.int32, [None, data.max_len], name="ulu")
in_v3 = tf.placeholder(tf.int32, [None, data.max_len], name="ulu")
labels_u1 = tf.placeholder(tf.float32, [None, data.max_len], name="lu1")
labels_v1 = tf.placeholder(tf.float32, [None, data.max_len], name="lv1")
labels_u2 = tf.placeholder(tf.float32, [None, data.max_len], name="lu2")
labels_v2 = tf.placeholder(tf.float32, [None, data.max_len], name="lv2")
labels_u3 = tf.placeholder(tf.float32, [None, data.max_len], name="lu3")
labels_v3 = tf.placeholder(tf.float32, [None, data.max_len], name="lv3")
